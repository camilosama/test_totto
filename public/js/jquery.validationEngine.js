...
/*****************************************************/
/****************************************************/
/********* Por Alejandro Sarmiento Beltrán **********/
		_onFieldEvent: function(event) {
			...
			if(field.val().length > 0){ /* Se agrega esta línea*/
...
/*****************************************************/
	...
	$.validationEngine= {fieldIdCounter: 0,defaults:{
		...
		// Delay before auto-hide //10000 por defecto
		autoHideDelay: 2000,
		// Fade out duration while hiding the validations // 0.3 por defecto
		fadeDuration: 0.2,
